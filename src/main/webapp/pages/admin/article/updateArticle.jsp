...
<nav class="nav-extended pink accent-1">
    <div class="nav-wrapper">
        <a href="/admin/article" class="breadcrumb">&nbsp;&nbsp;旅游资讯</a>
        <a href="/admin/article/update/${article.id}" class="breadcrumb">修改</a>
...
<div class="row" style="margin: 20px; display: block;">
    <form:form action="/admin/article/updateP" method="post" commandName="articleP" role="form">
        <div class="input-field col s6">
            <input type="text" class="form-control" id="title" name="title" placeholder="输入标题:" value="${article.title}"/>
        ...
        <div class="form-group col s6">
            ...
            <select class="browser-default" id="type.id" name="type.id">
                <c:forEach items="${typeList}" var="type">
                    <c:if test="${type.id==article.type.id}">
        ...
        <div class="input-field col s12">
            ...
            <textarea class="materialize-textarea" id="content" name="content" placeholder="输入正文">${article.content}</textarea>
        </div>
