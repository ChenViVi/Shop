...
<div class="row" style="margin: 20px; display: block;">
    <a href="/admin/music/add" type="button" class="waves-effect waves-light btn pink darken-1" style="margin-bottom: 20px;">添加音乐</a></h3>
        ...
        <table class="table highlight">
            ...
            <c:forEach items="${musicList}" var="music">
                <tr>
                    ...
                    <td>${music.score}</td>
                    <td>
                        <a href="/admin/music/update/${music.id}" type="button" class="btn btn-sm btn-success">修改</a>
                        <a href="/admin/music/delete/${music.id}" type="button" class="waves-effect waves-light btn red lighten-1">删除</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
