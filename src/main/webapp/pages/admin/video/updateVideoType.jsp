...
<nav class="nav-extended pink accent-1">
    <div class="nav-wrapper">
        <a href="/admin/music" class="breadcrumb">&nbsp;&nbsp;纪念品欣赏分类</a>
...
<div class="row" style="margin: 20px; display: block;">
    <form:form action="/admin/videoType/updateP" method="post" commandName="categoryP" role="form">
