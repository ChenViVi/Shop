...
<nav class="nav-extended pink accent-1">
    <div class="nav-wrapper">
        <a href="/admin/adminType" class="breadcrumb">&nbsp;&nbsp;旅游资讯分类</a>
...
<div class="row" style="margin: 20px; display: block;">
    <a href="/admin/articleType/add" type="button" class="waves-effect waves-light btn pink darken-1" style="margin-bottom: 20px;">添加分类</a></h3>
            ...
            <c:forEach items="${typeList}" var="type">
                <c:if test="${type.id != -1}">
                    <tr>
                        ...
                        <td>${type.name}</td>
                        <td>
                            <a href="/admin/articleType/update/${type.id}" type="button" class="btn btn-sm btn-success">修改</a>
                            <a href="/admin/articleType/delete/${type.id}" type="button" class="waves-effect waves-light btn red lighten-1">删除</a>
                        </td>
                    </tr>
                </c:if>
            </c:forEach>
