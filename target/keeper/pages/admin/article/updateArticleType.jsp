...
<nav class="nav-extended pink accent-1">
    <div class="nav-wrapper">
        <a href="/admin/articleType" class="breadcrumb">&nbsp;&nbsp;旅游资讯分类</a>
        <a href="/admin/articleType/update/${type.id}" class="breadcrumb">修改</a>
...
<div class="row" style="margin: 20px; display: block;">
    <form:form action="/admin/articleType/updateP" method="post" commandName="categoryP" role="form">
